<?php
// source: D:\Ambis\Bakalářka\Projekt/config/common.neon
// source: D:\Ambis\Bakalářka\Projekt/config/services.neon
// source: D:\Ambis\Bakalářka\Projekt/config/local.neon
// source: array
...
class Container_7c7b1d4ab3 extends Nette\DI\Container
{
	...
	protected $wiring = [
		...
		'App\Presenters\LandingpagePresenter' => [2 => ['application.4']],
		'App\Presenters\PraxePresenter' => [2 => ['application.5']],
		'App\Presenters\TestPresenter' => [2 => ['application.6']],
	...
	public function createServiceApplication__4(): App\Presenters\LandingpagePresenter
	{
		$service = new App\Presenters\LandingpagePresenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('01'),
	...
	public function createServiceApplication__5(): App\Presenters\PraxePresenter
	{
		$service = new App\Presenters\PraxePresenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('01'),
	...
	public function createServiceApplication__6(): App\Presenters\TestPresenter
	{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'D:\Ambis\Bakalářka\Projekt/temp/cache/nette.application/touch'
		));
	...
	{
		return new Nette\Caching\Storages\FileStorage('D:\Ambis\Bakalářka\Projekt/temp/cache');
	}


	public function createServiceContainer(): Container_7c7b1d4ab3
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_7c7b1d4ab3 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('D:\Ambis\Bakalářka\Projekt/temp/cache/latte');
